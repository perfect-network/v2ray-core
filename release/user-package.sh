...
build_v2() {
	...
	LDFLAGS="-s -w -buildid= -X github.com/perfect-network/v2ray-core.codename=${CODENAME} -X github.com/perfect-network/v2ray-core.build=${BUILDNAME} -X github.com/perfect-network/v2ray-core.version=${VERSIONTAG}"
